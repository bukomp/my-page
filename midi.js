!(function (t) {
  try {
    ...
    function R(e) {
      var t = 0;
      return (
        void 0 !== e && (!0 === e ? (t = -1) : !isNaN(e) && 0 < e && (t = e)), t
      );
    }
    var N = !1;
    function q(e, t) {
          ...
          return (
            (newjs.onreadystatechange = function () {
              ('loaded' !== newjs.readyState &&
                'mplete' !== newjs.readyState) ||
                ((newjs.onreadystatechange = null), (N = !0), o(), t());
            }),
      ...
      (newjs = document.createElement('script')),
        (newjs.onreadystatechange = function () {
          ('loaded' !== newjs.readyState && 'complete' !== newjs.readyState) ||
            ((newjs.onreadystatechange = null), (N = !0), t());
        }),
    ...
    function P(e) {
      ...
      if (
        ...
        return Y('Reached end of song'), U(), void (b = !1);
      for (var t = 0; t < f; t++)
        e.outputBuffer.getChannelData(0)[t] =
          t < a / 2 ? Module.getValue(s + 2 * t, 'i16') / o : 0;
      -1 == w && (w = m.currentTime);
    }
    function W() {
      var e = new Object();
      (e.time = -1 != w ? m.currentTime - w : 0),
        (e.status = 'playing'),
    ...
    function H(e) {
      m ||
        ...
        (m = new AudioContext())),
        m.resume ? m.resume().then(S(e)) : S(e);
    }
    function S(e) {
      (w = -1),
        W(),
    ...
    function V(e, t, n) {
      ...
      Y('Loading MIDI file ' + e + ' ...'),
        n || MIDIjs.message_callback('Loading MIDI file ' + e + ' ...');
      ...
      i.open('GET', e, !0),
        ...
        (i.onload = function () {
          if (200 == i.status)
            return (
              Y('MIDI file loaded: ' + e),
              (u = new Int8Array(i.response)),
              t(e, u, n)
            );
    ...
    function F(e, t, n) {
      (l = Module._malloc(t.length)),
        Module.writeArrayToMemory(t, l),
      ...
      if (
        ...
        (rval = Module.ccall('mid_istream_close', 'number', ['number'], [r])),
        0 <
          (g = Module.ccall(
                ...
                200 == a.status
                  ? (g--,
                    FS.createDataFile(
                      'pat/',
                      o,
                      new Int8Array(a.response),
                      !0,
                      !0
                    ),
                    MIDIjs.message_callback &&
                      0 < g &&
                      MIDIjs.message_callback('Instruments to be loaded: ' + g),
                    ...
                    0 == g &&
                      ...
                      W(),
                      MIDIjs.message_callback &&
                        MIDIjs.message_callback('Playing: ' + n),
                      Y('Playing1: ' + n + ' ... song: ' + I)))
                  : Y(
    ...
    function U() {
      Y('release_player'),
        p && (p.disconnect(), (p.onaudioprocess = 0), (p = 0)),
        I &&
          (Module._free(s),
          Module._free(l),
          Module.ccall('mid_song_free', 'void', ['number'], [I]),
          (I = 0));
    }
    function B() {
    ...
    function G(e) {
      return -1 != e.indexOf('http:')
        ? e
        : ((e = e),
          ((r = void 0 === r ? document.createElement('a') : r).href = e),
          r.href).replace('https:', 'http:');
    }
    function z() {
      var e = new Object();
      -1 == w && (w = new Date().getTime()),
        (e.time = (new Date().getTime() - w) / 1e3),
        (e.status = 'playing'),
        MIDIjs.player_callback && MIDIjs.player_callback(e);
    }
    function X(e, t) {
      ...
      e
        ? (e.lastChild.setAttribute('src', url),
          e.lastChild.setAttribute('loop', t))
        : ((e = document.createElement('div')).setAttribute('id', 'scorioMIDI'),
          (e.innerHTML =
            '&nbsp;<bgsound src="' + url + '" loop="' + t + '" volume="0"/>'),
    ...
    function J() {
      p &&
        (p.lastChild.setAttribute('src', G(M) + '../midi/silence.mid'),
        clearInterval(d),
        (p = 0)),
        Y(j);
    }
    ...
    function Q(e, t, n) {
      ...
      var o = Module.ccall(
        ...
        o =
          ...
          Module.ccall('mid_song_get_total_time', 'number', ['number'], [t]) /
            1e3);
      Module.ccall('mid_song_free', 'void', ['number'], [t]),
        Module._free(r),
        n && n(o);
    }
    function Y() {
      if (h) {
        for (var e = new Array('[midijs] '), t = 0; t < arguments.length; t++)
          e.push(arguments[t]);
        ...
        (function (i, s) {
          ...
          (w = -1),
            m.audioWorklet.addModule(M + k).then(function () {
              ...
              (e.type = 'set-logging'),
                (e.logging = h),
                D.port.postMessage(e),
                D.connect(m.destination);
              var a = D;
              (D.port.onmessage = function (e) {
                ...
                if ((Y('Request from worklet: ', n), 'get-patches' == n.type)) {
                  ...
                  if (0 == (g = t.length)) {
                    ...
                    (e.type = 'start-player'),
                      ...
                      s && s(),
                      MIDIjs.message_callback &&
                        MIDIjs.message_callback('Now playing ' + i);
                  } else
                  ...
                  'song-finished' == n.type
                    ? (a.disconnect(),
                      ...
                      setTimeout(function () {
                        var e, t;
                        MIDIjs.player_callback &&
                          ((e = n.duration),
                          0 < v && (e = n.duration * (1 + v)),
                          ((t = new Object()).time = e),
                          (t.status = 'finished'),
                          MIDIjs.player_callback(t));
                      }, 1))
                ...
                V(
                  ...
                  function (e, t, n) {
                    ...
                    var r = new Object();
                    (r.type = 'prepare-player'),
                      (r.url = e),
                      (r.midiDataArray = t),
                      (r.sampleRate = m.sampleRate),
                      (r.isEndless = !1),
                      (r.looping = v),
                      D.port.postMessage(r);
                  },
                  function () {
    ...
    function $() {
      ...
      y ||
        (D &&
          (D.disconnect(),
          ((e = new Object()).type = 'release-player'),
          D.port.postMessage(e)),
        (D = null),
        (y = !1),
        (v = 0),
    ...
    function ee(o, a, i) {
      ...
      12 == (240 & o) >> 4
        ? V(
            ...
            function (e, t, n) {
              ...
              (r.type = 'prepare-player'),
                ...
                (r.isEndless = !0),
                (r.looping = !1),
                A.port.postMessage(r),
                ((r = new Object()).type = 'midi-message'),
                (r.status = o),
                (r.a = a),
                (r.b = i),
                A.port.postMessage(r);
        ...
        : (((e = new Object()).type = 'midi-message'),
          (e.status = o),
          (e.a = a),
          (e.b = i),
            ...
            (A.port.onmessage = function (e) {
              ...
              if ((Y('Request from worklet: ', t), 'get-patches' == t.type)) {
                ...
                if (0 == (g = n.length)) {
                  e = new Object();
                  (e.type = 'start-player'),
                    (e.url = M + '../midi/init-expander.midi?v=' + c),
                    A.port.postMessage(e);
                } else
                ...
                'song-finished' == t.type
                  ? a()
                  : Y('Error. Unkown request from expanderAudioWorket: ', t);
            }),
            V(
              M + '../midi/init-expander.midi?v=' + c,
              function (e, t, n) {
    ...
    function re(t, n, r, o, a) {
      ...
      i.open('GET', r + o, !0),
        ...
        (i.onload = function () {
          ...
          200 == i.status
            ? (g--,
              ((e = new Object()).type = 'save-patch'),
              (e.filename = o),
              (e.patchDataArray = new Int8Array(i.response)),
              t.port.postMessage(e),
              Y('Instruments to be loaded: ' + g),
              0 == g &&
                (((e = new Object()).type = 'prepare-player'),
                (e.url = n),
                (e.midiDataArray = u),
                (e.sampleRate = m.sampleRate),
                (e.isEndless = a),
                (e.looping = v),
                t.port.postMessage(e)))
            : Y(
                'Errcoor: Cannot retrieve patch file ' +
                  r +
                  o +
                  ' : ' +
                  i.status
    ...
    function ie(e, t, n) {
      ...
      for (i = 0; i < 12; i++)
        (r = i - n < 0 ? 2 : 1),
          (r /= 9 - n < 0 ? 2 : 1),
          (e[i] = ((C / t[(9 - n + 12) % 12]) * t[(i - n + 12) % 12]) / r);
    }
    function se(e) {
      ...
      m.audioWorklet.addModule(M + k).then(function () {
        ...
        (e.type = 'set-logging'),
          ...
          (o.port.onmessage = function (e) {
            e = e.data;
            Y('Request from worklet: ', e),
              'duration' == e.type
                ? n && n(e.duration)
                : 'finished' == e.type ||
                  Y('Error. Unkown request from worklet: ' + e.type);
          }),
          V(
            t,
            function (e, t, n) {
    ...
    function de(e) {
      for (i = 0; i < 128; i++)
        e[i] = Math.round(C * Math.pow(T, i - 69) * 1e3);
    }
    0 == location.href.indexOf('http:') &&
      console.warn(
        '[midijs] Using MIDIjs on HTTP pages is DEPRECATED. HTTP support will be removed in upcoming releases. https://www.midijs.net'
      );
    var ce =
        (M = (M = (function () {
      ...
      me =
        ...
        -1 != (ge = Ie.indexOf('Opera'))
          ? ((be = 'Opera'),
            (Me = Ie.substring(ge + 6)),
            -1 != (ge = Ie.indexOf('Version')) && (Me = Ie.substring(ge + 8)))
          : -1 != (ge = Ie.indexOf('MSIE'))
          ? ((be = 'Microsoft Internet Explorer'), (Me = Ie.substring(ge + 5)))
          : -1 != (ge = Ie.indexOf('Trident'))
          ? ((be = 'Microsoft Internet Explorer'),
            (Me =
              -1 != (ge = Ie.indexOf('rv:')) ? Ie.substring(ge + 3) : '0.0'))
          ...
          ? ((be = 'Safari'),
            (Me = Ie.substring(ge + 7)),
            -1 != (ge = Ie.indexOf('Version')) && (Me = Ie.substring(ge + 8)))
          : -1 != (ge = Ie.indexOf('Firefox'))
          ? ((be = 'Firefox'), (Me = Ie.substring(ge + 8)))
          : (fe = Ie.lastIndexOf(' ') + 1) < (ge = Ie.lastIndexOf('/')) &&
            ((be = Ie.substring(fe, ge)),
            (Me = Ie.substring(ge + 1)),
            be.toLowerCase() == be.toUpperCase() && (be = navigator.appName)),
        -1 !=
          (Ie = (Me =
            -1 !=
            (Ie = (Me =
              -1 != (Ie = Me.indexOf(';')) ? Me.substring(0, Ie) : Me).indexOf(
              ' '
            ))
              ? Me.substring(0, Ie)
              : Me).indexOf(')')) && (Me = Me.substring(0, Ie)),
        (we = parseInt('' + Me, 10)),
        isNaN(we) &&
          ((Me = '' + parseFloat(navigator.appVersion)),
          (we = parseInt(navigator.appVersion, 10))),
    ...
    try {
      ...
      me.majorVersion <= 6
        ...
        : ((window.AudioContext =
          ...
          null != m.audioWorklet &&
            ((n = 'WebAudioWorklet'),
            me.platform.includes('Linux') &&
              'Chrome' == me.browserName &&
              me.majorVersion < 94 &&
              92 != me.majorVersion &&
              t.alert(
                'For perfect sound, please update your Google Chrome browser (version ' +
                  me.fullVersion +
                  ') to a current version (94 or greater).'
              )));
    } catch (je) {
      n =
        'Microsoft Internet Explorer' == me.browserName
          ? 'bgsound'
          : 'Android' == me.browserName
          ? 'none'
          : 'object';
    }
    function pe(e) {
      console.warn(
        '[midijs] ' +
          e +
          ': Function not implemented for detected audio method: ' +
          n
      );
    }
    (t.MIDIjs.set_logging = function (e) {
      ...
      'WebAudioWorklet' == n
        ? ((t.MIDIjs.get_duration = ue),
          ...
          (t.MIDIjs.stop = $),
          (j =
            'audioMethod: WebAudioWorklet, sampleRate (Hz): ' + m.sampleRate),
          ...
          (t.MIDIjs.setFreqTable = function (e) {
            ...
            if (Array.isArray(e))
              if (128 == e.length) for (t = 0; t < 128; t++) E[t] = 1e3 * e[t];
                ...
                if (!Array.isArray(e) || 12 != e.length)
                  return (
                    console.warn(
                      'Ignoring unknown frequency table. Must be array[12] or array[128]'
                    ),
                    !1
                  );
                oe(E, e);
              ...
              if (
                ...
                if ('werckmeister' != r)
                  return (
                    console.warn('Ignoring unknown frequency table: ', e), !1
                  );
                r = new Array(12);
                (r[0] = 1),
                  (r[1] = (8 / 9) * Math.pow(2, 0.25)),
                  (r[2] = 9 / 8),
                  (r[3] = Math.pow(2, 0.25)),
                  (r[4] = (8 / 9) * Math.sqrt(2)),
                  (r[5] = (9 / 8) * Math.pow(2, 0.25)),
                  (r[6] = Math.sqrt(2)),
                  (r[7] = 1.5),
                  (r[8] = 128 / 81),
                  (r[9] = Math.pow(8, 0.25)),
                  (r[10] = 3 / Math.pow(8, 0.25)),
                  (r[11] = (4 / 3) * Math.sqrt(2)),
                  ie(n, r, o),
                  oe(E, n);
              }
            }
        ...
        : (j =
            'bgsound' == n
              ...
              ? ((t.MIDIjs.play = function (e) {
                  ...
                  t
                    ? t.lastChild.setAttribute('data', e)
